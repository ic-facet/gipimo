...
const STATIONS = {
    ...
    receivers: [
        { id: "CHL", name: "LAVNet-Cl", lat: -38.00, lon: -50, location: "Chillán, CHL" }
    ]
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    worldMapImage.src = '/static/lavnetchile/images/mapamundi_pacifico.png';
...
// Función para dibujar placas con borde (para contraste)
...
function drawTimeZoneLabel() {
    ...
    const zacReceiver = STATIONS.receivers.find(r => r.id === 'UAZ');
    const label = zacReceiver ? `UTC-6 (${zacReceiver.location})` : 'UTC-4 (Chillán, Chl)';
