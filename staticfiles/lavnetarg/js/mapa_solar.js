...
const STATIONS = {
    ...
    receiver: { name: 'Tucumán', lat: -26.8167, lon: -65.2167, location: 'Tucumán, Argentina' }
};
...
function drawTimeZoneLabel() {
    ...
    ctx.textAlign = 'left';
    ctx.fillText('UTC-3 (Tucumán)', 15, 25);
...
function updateInfo(sunPos) {
    ...
    // Local (Forzamos a UTC-3 para Tucumán, Argentina)
    const localMs = currentTime.getTime() - (3 * 60 * 60 * 1000); 
