...
const STATIONS = {
    ...
    receiver: { name: 'Zacatecas', lat: 22.77, lon: -102.58, location: 'Zacatecas, MX' }
};
...
function drawTimeZoneLabel() {
    ...
    ctx.textAlign = 'left';
    ctx.fillText('UTC-6 (Zacatecas)', 15, 25);
...
function updateInfo(sunPos) {
    ...
    // Local (Forzamos a UTC-6 para Zacatecas visualmente, aunque el navegador sea otro)
