...
const STATIONS = {
    ...
    receiver: { name: 'UNAM', lat: 22.77, lon: -102.58, location: 'UNAM, MX' }
};
...
function updateInfo(sunPos) {
    ...
    // Local (Forzamos a UTC-6 para UNAM visualmente, aunque el navegador sea otro)
